...
public class LedgerService {
 ...
 public LedgerService(LedgerEntryRepository ledgerRepo, WalletRepository walletRepo) {
 ...
 * @throws InsufficientFundsException 
 ...
 /**
  * Single-wallet credit (e.g. top-up). {@code referenceId} is stored as {@code payment_id}
  * on the ledger row for traceability; it is not required to reference a {@link com.securepay.transaction.model.Payment} row.
  */
 public void writeSingleWalletCredit(
         Wallet wallet,
         BigDecimal amount,
         UUID referenceId,
         String description
 ...
 /**
  * Single-wallet debit (e.g. withdrawal). Caller must hold {@code SELECT FOR UPDATE} on the wallet row.
  *
  * @throws InsufficientFundsException if balance is insufficient
  */
 public void writeSingleWalletDebit(
         Wallet wallet,
         BigDecimal amount,
         UUID referenceId,
         String description
